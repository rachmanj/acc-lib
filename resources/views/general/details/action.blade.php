...
<button class="btn btn-xs btn-warning" data-toggle="modal" data-target="#general-edit-{{ $model->id }}">edit</button>

<div class="modal fade" id="general-edit-{{ $model->id }}">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <form action="{{ route('general.update', $model->id) }}" method="POST">
        @csrf @method('PUT')
